...
class Voyage extends Model
{
    ...
    protected $casts = [
        ...
        'total_cargo_capacity_tons' => 'decimal:2',
        'total_cargo_weight_loaded' => 'decimal:2',
        'capacity_utilization_percentage' => 'decimal:2',
    ...
    protected static function boot()
    {
        ...
        // Auto-calcular vessel_count basado en shipments
        static::saved(function ($voyage) {
            $voyage->recalculateShipmentStats();
        });
    }
    ...
    {
        return $this->belongsTo(CustomsOffice::class, 'origin_customs_id');
    }
    ...
    {
        return $this->belongsTo(CustomsOffice::class, 'destination_customs_id');
    }
    ...
    {
        return $this->belongsTo(CustomsOffice::class, 'transshipment_customs_id');
    }
    ...
    /**
     * Usuario que actualizó el viaje por última vez
     */
    ...
    /**
     * Envíos individuales del viaje (convoy o embarcación única)
     */
    public function shipments(): HasMany
    {
        return $this->hasMany(Shipment::class)->orderBy('sequence_in_voyage');
    }

    /**
     * Conocimientos de embarque del viaje
     */

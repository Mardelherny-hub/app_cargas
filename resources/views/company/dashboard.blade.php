            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold">{{ $company->commercial_name ?? $company->business_name }}
                            </h1>
                            <p class="text-blue-100 mt-1">CUIT: {{ $company->tax_id }} |
                                {{ $company->country === 'AR' ? 'Argentina' : 'Paraguay' }}</p>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                @if ($company->certificate_path)
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-2 {{ $certificateStatus['is_valid'] ? 'text-green-300' : 'text-red-300' }}"
                                ...
                                <div class="flex items-center">
                                    <div
                                        class="w-3 h-3 mr-2 rounded-full {{ $company->ws_active ? 'bg-green-400' : 'bg-gray-400' }}">
                                    </div>
                                    <span class="text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['total_shipments'] ?? 0 }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium text-yellow-600">{{ $stats['pending_shipments'] ?? 0 }}</span>
                                pendientes
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium text-blue-600">{{ $stats['active_trips'] ?? 0 }}</span> en
                                curso
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['total_operators'] ?? 0 }}
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium text-green-600">{{ $stats['active_operators'] ?? 0 }}</span>
                                activos
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium text-green-600">+{{ $stats['revenue_growth'] ?? 0 }}%</span>
                                vs mes anterior
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            @forelse($recentActivity as $activity)
                                <div class="flex items-start space-x-3">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-2 h-2 bg-{{ $activity['color'] ?? 'blue' }}-500 rounded-full mt-2">
                                        </div>
                                    </div>
                            ...
                            @empty
                                <div class="text-center py-6">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">No hay eventos registrados en las últimas 24
                                        horas</p>
                                </div>
                            @endforelse
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200">
                            <div class="flex justify-between space-x-4">
                                ...
                                <a href="{{-- r#oute('company.webservices.config') --}}#"
                                    class="text-sm text-blue-600 hover:text-blue-500">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600">
                                {{ $todaysSummary['shipments_created'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Cargas creadas</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ $todaysSummary['trips_started'] ?? 0 }}
                            </div>
                            <div class="text-sm text-gray-600">Viajes iniciados</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-purple-600">
                                {{ $todaysSummary['shipments_delivered'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Cargas entregadas</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-yellow-600">
                                ${{ number_format($todaysSummary['revenue_today'] ?? 0, 0, ',', '.') }}</div>

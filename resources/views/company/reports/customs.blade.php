        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Reportes Aduaneros') }}
                </h2>
                <p class="text-sm text-gray-600 mt-1">
                    Consulta y exporta la documentación requerida por las autoridades aduaneras.
                </p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="px-6 py-4">
                    <form method="GET" action="{{ route('company.reports.customs') }}">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="ID de Transacción, Buque..."
            ...
            <!-- Listado de Reportes Aduaneros -->
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">
                        Reportes Aduaneros Encontrados
                    </h3>
                </div>
                <div class="overflow-hidden">
                    @if(isset($customsReports) && $customsReports->count() > 0)
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">No se encontraron reportes aduaneros</h3>

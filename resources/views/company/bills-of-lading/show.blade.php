    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                {{--
                    Los datos de proveniencia Login siguen persistidos para
                    trazabilidad y generación aduanera, pero no se muestran
                    como un panel exclusivo: la ficha conserva la misma UI
                    operativa que los demás formatos importados.
                --}}

        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <div class="pt-4">
                ...
                <div class="mt-2 space-y-1">
                    ...
                    {{-- Archivos MANE/Malvina: solo si la empresa tiene ID María cargado --}}
                    @if($company && !empty($company->id_maria))
                    <a href="{{ route('company.mane.index') }}" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('company.mane.index') ? 'bg-indigo-100 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        🏷️ Archivos MANE/Malvina
                    </a>
                    @endif
                </div>
            </div>

<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Editar: {{ $vesselType->name }}</h1>
                        <p class="mt-1 text-sm text-gray-600">Código: {{ $vesselType->code }}</p>
                    </div>
            ...
            <!-- Formulario -->
            <form method="POST" action="{{ route('admin.vessel-types.update', $vesselType) }}" class="space-y-8" id="vessel-type-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code', $vesselType->code) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $vesselType->name) }}" required
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="short_name" id="short_name" value="{{ old('short_name', $vesselType->short_name) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <select name="category" id="category" required
                                    ...
                                    <option value="barge" {{ old('category', $vesselType->category) == 'barge' ? 'selected' : '' }}>Barcaza</option>
                                    <option value="tugboat" {{ old('category', $vesselType->category) == 'tugboat' ? 'selected' : '' }}>Remolcador</option>
                                    <option value="pusher" {{ old('category', $vesselType->category) == 'pusher' ? 'selected' : '' }}>Empujador</option>
                                    <option value="self_propelled" {{ old('category', $vesselType->category) == 'self_propelled' ? 'selected' : '' }}>Autopropulsado</option>
                                    <option value="mixed" {{ old('category', $vesselType->category) == 'mixed' ? 'selected' : '' }}>Mixto</option>
                                </select>
                                @error('category')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="propulsion_type" id="propulsion_type" required
                                    ...
                                    <option value="self_propelled" {{ old('propulsion_type', $vesselType->propulsion_type) == 'self_propelled' ? 'selected' : '' }}>Autopropulsado</option>
                                    <option value="towed" {{ old('propulsion_type', $vesselType->propulsion_type) == 'towed' ? 'selected' : '' }}>Remolcado</option>  
                                    <option value="pushed" {{ old('propulsion_type', $vesselType->propulsion_type) == 'pushed' ? 'selected' : '' }}>Empujado</option>
                                    <option value="hybrid" {{ old('propulsion_type', $vesselType->propulsion_type) == 'hybrid' ? 'selected' : '' }}>Híbrido</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $vesselType->display_order) }}" min="1"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Descripción detallada del tipo de embarcación...">{{ old('description', $vesselType->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-1">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_length" id="min_length" value="{{ old('min_length', $vesselType->min_length) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínima">
                                    </div>
                                    <div>
                                        <input type="number" name="max_length" id="max_length" value="{{ old('max_length', $vesselType->max_length) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máxima">
                                    </div>
                            ...
                            <div class="lg:col-span-1">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_beam" id="min_beam" value="{{ old('min_beam', $vesselType->min_beam) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínima">
                                    </div>
                                    <div>
                                        <input type="number" name="max_beam" id="max_beam" value="{{ old('max_beam', $vesselType->max_beam) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máxima">
                                    </div>
                            ...
                            <div class="lg:col-span-1">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_draft" id="min_draft" value="{{ old('min_draft', $vesselType->min_draft) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínimo">
                                    </div>
                                    <div>
                                        <input type="number" name="max_draft" id="max_draft" value="{{ old('max_draft', $vesselType->max_draft) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máximo">
                                    </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="min_water_depth" id="min_water_depth" value="{{ old('min_water_depth', $vesselType->min_water_depth) }}" 
                                       step="0.01" min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="px-6 py-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_cargo_capacity" id="min_cargo_capacity" value="{{ old('min_cargo_capacity', $vesselType->min_cargo_capacity) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínima">
                                    </div>
                                    <div>
                                        <input type="number" name="max_cargo_capacity" id="max_cargo_capacity" value="{{ old('max_cargo_capacity', $vesselType->max_cargo_capacity) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máxima">
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_container_capacity" id="min_container_capacity" value="{{ old('min_container_capacity', $vesselType->min_container_capacity) }}" 
                                               min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínima">
                                    </div>
                                    <div>
                                        <input type="number" name="max_container_capacity" id="max_container_capacity" value="{{ old('max_container_capacity', $vesselType->max_container_capacity) }}" 
                                               min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máxima">
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="number" name="min_liquid_capacity" id="min_liquid_capacity" value="{{ old('min_liquid_capacity', $vesselType->min_liquid_capacity) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Mínima">
                                    </div>
                                    <div>
                                        <input type="number" name="max_liquid_capacity" id="max_liquid_capacity" value="{{ old('max_liquid_capacity', $vesselType->max_liquid_capacity) }}" 
                                               step="0.01" min="0"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                               placeholder="Máxima">
                                    </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_containers" id="handles_containers" value="1" 
                                           {{ old('handles_containers', $vesselType->handles_containers) ? 'checked' : '' }}
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_bulk_cargo" id="handles_bulk_cargo" value="1" 
                                           {{ old('handles_bulk_cargo', $vesselType->handles_bulk_cargo) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_general_cargo" id="handles_general_cargo" value="1" 
                                           {{ old('handles_general_cargo', $vesselType->handles_general_cargo) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_liquid_cargo" id="handles_liquid_cargo" value="1" 
                                           {{ old('handles_liquid_cargo', $vesselType->handles_liquid_cargo) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_dangerous_goods" id="handles_dangerous_goods" value="1" 
                                           {{ old('handles_dangerous_goods', $vesselType->handles_dangerous_goods) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_refrigerated_cargo" id="handles_refrigerated_cargo" value="1" 
                                           {{ old('handles_refrigerated_cargo', $vesselType->handles_refrigerated_cargo) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="handles_oversized_cargo" id="handles_oversized_cargo" value="1" 
                                           {{ old('handles_oversized_cargo', $vesselType->handles_oversized_cargo) ? 'checked' : '' }}
                                           class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="river_navigation" id="river_navigation" value="1" 
                                               {{ old('river_navigation', $vesselType->river_navigation) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="maritime_navigation" id="maritime_navigation" value="1" 
                                               {{ old('maritime_navigation', $vesselType->maritime_navigation) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="coastal_navigation" id="coastal_navigation" value="1" 
                                               {{ old('coastal_navigation', $vesselType->coastal_navigation) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="lake_navigation" id="lake_navigation" value="1" 
                                               {{ old('lake_navigation', $vesselType->lake_navigation) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="can_be_lead_vessel" id="can_be_lead_vessel" value="1" 
                                               {{ old('can_be_lead_vessel', $vesselType->can_be_lead_vessel) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="can_be_in_convoy" id="can_be_in_convoy" value="1" 
                                               {{ old('can_be_in_convoy', $vesselType->can_be_in_convoy) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="can_push_barges" id="can_push_barges" value="1" 
                                               {{ old('can_push_barges', $vesselType->can_push_barges) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="can_tow_barges" id="can_tow_barges" value="1" 
                                               {{ old('can_tow_barges', $vesselType->can_tow_barges) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="number" name="max_barges_in_convoy" id="max_barges_in_convoy" value="{{ old('max_barges_in_convoy', $vesselType->max_barges_in_convoy) }}" 
                                           min="0"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Ej: 8">
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <input type="number" name="typical_crew_size" id="typical_crew_size" value="{{ old('typical_crew_size', $vesselType->typical_crew_size) }}" 
                                           min="0"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Tripulación típica">
                                    <input type="number" name="max_crew_size" id="max_crew_size" value="{{ old('max_crew_size', $vesselType->max_crew_size) }}" 
                                           min="0"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <input type="number" name="typical_speed" id="typical_speed" value="{{ old('typical_speed', $vesselType->typical_speed) }}" 
                                           step="0.1" min="0"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                           placeholder="Velocidad típica">
                                    <input type="number" name="max_speed" id="max_speed" value="{{ old('max_speed', $vesselType->max_speed) }}" 
                                           step="0.1" min="0"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <input type="number" name="fuel_consumption_per_day" id="fuel_consumption_per_day" value="{{ old('fuel_consumption_per_day', $vesselType->fuel_consumption_per_day) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="typical_voyage_duration" id="typical_voyage_duration" value="{{ old('typical_voyage_duration', $vesselType->typical_voyage_duration) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="loading_time_hours" id="loading_time_hours" value="{{ old('loading_time_hours', $vesselType->loading_time_hours) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="unloading_time_hours" id="unloading_time_hours" value="{{ old('unloading_time_hours', $vesselType->unloading_time_hours) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="px-6 py-4">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_pilot" id="requires_pilot" value="1" 
                                               {{ old('requires_pilot', $vesselType->requires_pilot) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_tugboat_assistance" id="requires_tugboat_assistance" value="1" 
                                               {{ old('requires_tugboat_assistance', $vesselType->requires_tugboat_assistance) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_special_permits" id="requires_special_permits" value="1" 
                                               {{ old('requires_special_permits', $vesselType->requires_special_permits) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_insurance" id="requires_insurance" value="1" 
                                               {{ old('requires_insurance', $vesselType->requires_insurance) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_safety_certificate" id="requires_safety_certificate" value="1" 
                                               {{ old('requires_safety_certificate', $vesselType->requires_safety_certificate) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="requires_dry_dock" id="requires_dry_dock" value="1" 
                                               {{ old('requires_dry_dock', $vesselType->requires_dry_dock) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="imo_type_code" id="imo_type_code" value="{{ old('imo_type_code', $vesselType->imo_type_code) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                @error('imo_type_code')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="inland_vessel_code" id="inland_vessel_code" value="{{ old('inland_vessel_code', $vesselType->inland_vessel_code) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="text" name="imdg_class" id="imdg_class" value="{{ old('imdg_class', $vesselType->imdg_class) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="argentina_ws_code" id="argentina_ws_code" value="{{ old('argentina_ws_code', $vesselType->argentina_ws_code) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            ...
                            <div>
                                ...
                                <input type="text" name="paraguay_ws_code" id="paraguay_ws_code" value="{{ old('paraguay_ws_code', $vesselType->paraguay_ws_code) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="daily_charter_rate" id="daily_charter_rate" value="{{ old('daily_charter_rate', $vesselType->daily_charter_rate) }}" 
                                       step="0.01" min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="fuel_cost_per_day" id="fuel_cost_per_day" value="{{ old('fuel_cost_per_day', $vesselType->fuel_cost_per_day) }}" 
                                       step="0.01" min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" name="typical_lifespan_years" id="typical_lifespan_years" value="{{ old('typical_lifespan_years', $vesselType->typical_lifespan_years) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="maintenance_interval_days" id="maintenance_interval_days" value="{{ old('maintenance_interval_days', $vesselType->maintenance_interval_days) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="dry_dock_interval_months" id="dry_dock_interval_months" value="{{ old('dry_dock_interval_months', $vesselType->dry_dock_interval_months) }}" 
                                       min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="bg-white shadow rounded-lg">
                    ...
                    <div class="px-6 py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="active" id="active" value="1" 
                                               {{ old('active', $vesselType->active) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_common" id="is_common" value="1" 
                                               {{ old('is_common', $vesselType->is_common) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_specialized" id="is_specialized" value="1" 
                                               {{ old('is_specialized', $vesselType->is_specialized) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                            ...
                            <div>
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="icon" id="icon" value="{{ old('icon', $vesselType->icon) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    ...
                                    <div>
                                        ...
                                        <input type="color" name="color_code" id="color_code" value="{{ old('color_code', $vesselType->color_code ?: '#3B82F6') }}"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-3">Información de Registro</label>
                                <div class="text-sm text-gray-600 space-y-2">
                                    <div>
                                        <span class="font-medium">Creado:</span> {{ $vesselType->created_at->format('d/m/Y H:i') }}
                                    </div>
                                    <div>
                                        <span class="font-medium">Actualizado:</span> {{ $vesselType->updated_at->format('d/m/Y H:i') }}
                                    </div>
                                    @if($vesselType->createdByUser)
                                        <div>
                                            <span class="font-medium">Por:</span> {{ $vesselType->createdByUser->name }}
                                        </div>
                                    @endif
                                </div>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const importantFields = ['code', 'category', 'active'];
        importantFields.forEach(fieldName => {
            const field = document.getElementById(fieldName);
            if (field) {
                const originalValue = field.value || (field.type === 'checkbox' ? field.checked : '');
                ...
                field.addEventListener('change', function() {
                    ...
                    if (currentValue != originalValue) {
                        ...
                        const confirmed = confirm(`¿Está seguro de cambiar ${fieldLabel}? Este cambio puede afectar las embarcaciones existentes de este tipo.`);
                        if (!confirmed) {

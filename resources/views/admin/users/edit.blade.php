        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form id="editUserForm" method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div>
                                        ...
                                        <select name="timezone" 
                                            ...
                                            <option value="America/Argentina/Buenos_Aires" 
                                                {{ old('timezone', $user->timezone) === 'America/Argentina/Buenos_Aires' ? 'selected' : '' }}>
                                                Buenos Aires (Argentina)
                                            </option>
                                            <option value="America/Asuncion" 
                                                {{ old('timezone', $user->timezone) === 'America/Asuncion' ? 'selected' : '' }}>
                                                Asunción (Paraguay)
                                            </option>
                                            <option value="UTC" 
                                                {{ old('timezone', $user->timezone) === 'UTC' ? 'selected' : '' }}>
                                                UTC
                                            </option>
                                        </select>
                                    </div>

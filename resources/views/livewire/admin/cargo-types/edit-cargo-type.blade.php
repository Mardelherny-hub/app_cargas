<div>
    ...
    <form wire:submit.prevent="save">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    @foreach ($columns as $col)
                        ...
                        <div>
                            ...
                            @elseif ($isJs)
                                ...
                                <p class="mt-1 text-xs text-gray-500">Editá un JSON válido (se valida al guardar).</p>
            ...
            {{-- Botonera --}}
            <div class="bg-white shadow-sm rounded-xl p-4 flex items-center justify-between gap-2">
                <div class="text-sm text-gray-500">
                    {{-- Info corta del registro (opcional, no asumimos columnas específicas) --}}
                    <span>{{ __('ID:') }} {{ $cargoType->id }}</span>
                </div>
                <div class="flex items-center gap-2">
                    <a href="{{ route('admin.cargo-types.index') }}"
